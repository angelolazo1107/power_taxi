...
android {
    ...
    defaultConfig {
        ...
        val gitCode = androidGitVersion.code()
        versionCode = if (gitCode > 0) gitCode else flutter.versionCode

        val gitName = androidGitVersion.name()
        versionName = if (gitName.isNotEmpty() && gitName != "unspecified") gitName else flutter.versionName
    }
