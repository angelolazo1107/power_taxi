...
class LoginForm extends StatefulWidget {
  ...
  final Function(String name, String pin, String? selectedDevice)? onDriverLogin;
      ...
      children: [
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            onPressed: widget.isLoading ? null : () => widget.onDriverLogin?.call(_nameController.text, _pinController.text, null),
