...
class MeterInitial extends TaxiMeterState {
  ...
  MeterInitial copyWith({
    ...
    return MeterInitial(
      ...
      shiftFlowEnabled: shiftFlowEnabled ?? this.shiftFlowEnabled,
