...
class HardwareMeterService {
  ...
  Future<void> printOfficialReceipt({
    ...
    try {
      ...
      debugPrint("ℹ️ SunmiPrinter SDK skipped (Non-Sunmi hardware): $e");
    }
    ...
    try {
      await _commandChannel.invokeMethod('printReceipt', {
        'receiptText': reportTxt.toString(),
        'fare': finalFare,
        'distance': distanceMeters,
      });
    } catch (e) {
      debugPrint("⚠️ Native Howen serial print error: $e");
    }
  ...
  Future<void> printXReading({
    ...
    try {
      ...
      debugPrint("ℹ️ SunmiPrinter SDK skipped for X-Reading: $e");
    }
  ...
  Future<void> printZReading({
    ...
    try {
      ...
      debugPrint("ℹ️ SunmiPrinter SDK skipped for Z-Reading: $e");
    }
  ...
  Future<void> printRemittanceReport({
    ...
    try {
      ...
      debugPrint("ℹ️ SunmiPrinter SDK skipped for Remittance: $e");
    }
  ...
  Future<void> printActivityLogReport({
    ...
    try {
      ...
      debugPrint("ℹ️ SunmiPrinter SDK skipped for Activity Log: $e");
    }
