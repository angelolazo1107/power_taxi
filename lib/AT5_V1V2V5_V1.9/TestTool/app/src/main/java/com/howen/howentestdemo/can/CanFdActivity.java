...
public class CanFdActivity extends Activity
{
	private static String TAG = "CanFdActivity";
	private SharedPreferences mSharedPreferences;
	public static final String CAN_PRE = "CanFdActivity";
	public static final String BITRATE = "bitrate";
	public static final String DBITRATE = "dbitrate";
	...
	protected Spinner mBitrate,mDbitrate,mSleepTime;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.can_fd);
	...
	public int getValue(String key)
	{
		...
		{
			return mSharedPreferences.getInt(key,9);
		}else if(key.equals(DBITRATE))
		{
	...
	private void initView() 
	{
		...
		mDbitrate = (Spinner) findViewById(R.id.dbitrate);
		...
		mDbitrate.setOnItemSelectedListener(new ItemSelectedEvent());
		...
		mDbitrate.setSelection(getValue(DBITRATE));
	 ...
	 class ItemSelectedEvent implements Spinner.OnItemSelectedListener
	 {
			public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3)
			{
				...
				}else if(arg0 == mDbitrate)
				{
					putValue(DBITRATE,arg2);
	...
	public void OpenCan() 
	{
		if(mCanEnabled)
		{
			...
			String Dbitrate=mDbitrate.getSelectedItem().toString();
			if(mCanManager.openCanfd(Bitrate,Dbitrate)>0)
			{
				String SleepTime=mSleepTime.getSelectedItem().toString();
				int index=SleepTime.indexOf("(ms)");
				int sleep=10;
